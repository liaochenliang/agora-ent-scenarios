...
//        apiConfig?.engine?.addDelegate(apiDelegateHandler)
        apiConfig?.engine?.delegate = apiDelegateHandler
        initTimer()
    }
...
extension KTVApiImpl: AgoraRtcMediaPlayerDelegate {
   ...
   func AgoraRtcMediaPlayer(_ playerKit: AgoraRtcMediaPlayerProtocol, didChangedTo position: Int) {
    ...
    func AgoraRtcMediaPlayer(_ playerKit: AgoraRtcMediaPlayerProtocol, didChangedTo state: AgoraMediaPlayerState, error: AgoraMediaPlayerReason) {
...
//        let headPhones: [AgoraAudioOutputRouting] = [.headset, .headsetBluetooth, .headsetNoMic]
        let headPhones: [AgoraAudioOutputRouting] = [.headset, .bluetoothDeviceHfp, .headsetNoMic]
